...
enum LiminalThemeCatalog {
    ...
    static let daybreak = LiminalThemeDefinition(
        ...
        palette: LiminalPalette(
            ...
            dusk: "#A78BE5",
            gradientTop: "#F8F0FA",
            gradientMiddle: "#E8D8F8",
            gradientBottom: "#FFE4DA",
            cardBottom: "#EFE4F7"
        ),
        surface: LiminalSurfaceTreatment(
            style: .solid,
            baseColor: nil,
            tintFillOpacity: 0.16,
            strokeOpacity: 0.46,
            strokeWidth: 1
        ),
        glass: LiminalGlassTreatment(
            fillColor: UIColor(liminalHex: "#FFF9FC"),
            fillOpacity: 1,
            strokeColor: UIColor(liminalHex: "#D8C9E6"),
            strokeOpacity: 0.72,
            strokeWidth: 1
        ),
        emphasis: LiminalTextEmphasis(secondaryOpacity: 1, tertiaryOpacity: 1),
