...
enum SharedModelContainer {
    ...
    private static let currentDevelopmentStoreVersion = 2026053005
    private static let requiredDevelopmentStoreColumns: [(table: String, columns: [String])] = [
        ...
        ("ZFRIEND", ["ZSTATUSRAWVALUE", "ZPROFILEBADGEID", "ZPROFILEICONFRAMEID", "ZPROFILESTREAKICONID", "ZPROFILECARDSTYLEID", "ZSTREAKCOUNT"])
    ]
